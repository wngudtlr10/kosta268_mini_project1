...
const dummyData = [
  {
    ...
    location: "상록보육원",
    detail:
      "작성하시오.작성하시오.작성하시오.작성하시오.작성하시오.작성하시오.작성하시오.",
  ...
  },
  {
    ...
    location: "북한산 국립공원",
    detail:
      ">모집대상 : 국립공원 관리 후원 및 정기적 봉사활동 가능 기업∙ 단체<br/>>모집기간 : 상시모집<br/>>활동장소<br/>-전국 국립공원 주요 탐방로(자연관찰로, 특별보호구, 해변)<br/>-참여기업∙단체의 희망공원 후원규모, 봉사활동계획(인원, 활동횟수 등)에 따라 탐방로 배정<br/>>활동분야 : 탐방로 정비 자원보전∙복원∙모니터링 공원환경정화 지역사회협력 기타 공원관리업무<br/>>활동기간 : 매년 12월까지 (1년 단위)<br/>>참여문의 :국립공원공단 각 공원사무소 자원보전과",
  ...
  },
  {
    ...
    location: "구룡초등학교",
    detail:
      "1.담당자 성명 : 동행담당 곽수진<br/>담당자 연락처(연락시주의사항및 연락가능시간) : 010-0000-0000<br/><br/>2.봉사활동세부내역<br/>진로관련 교육과 체육활동, 수학 학습 지도 부탁드립니다.<br/><br/>3. 봉사신청 참고사항<br/>북한 출생 학생과 남한 출생 학생입니다.<br/><br/>4. 온라인 봉사 선택 안내 : 전체 대면 봉사 , 혹은 사회적 거리두기 단계에 따라 온라인 봉사 병행 가능(사전협의 후 진행 예정).",
  ...
  },
  {
    ...
    location: "강릉 안인해변",
    detail:
      "활동내용<br/>– 09:00~09:30 해양환경 및 안전 교육, 활동안내<br/>– 09:30~11:30 해앙쓰레기 수거, 분류, 기록, 무게 측정<br/>– 11:30~12:00 활동 소감 나누기, 마무리<br/>(※ 악천후 시, 활동이 취소될 수 있습니다.)<br/>(※ 활동 전날, 최종 공지 문자(또는 전화)를 드리오니 확인하여 주십시오.)<br/><br/> 모집대상 <br/>남녀노소 누구나 가능(※ 단, 초등·중학생은 보호자와 동행해 주세요.)",
  ...
  },
  {
    ...
    location: "성동구 케어요양원",
    detail:
      "활동내용<br/>-활동 보조 : 어르신 일상생활 활동보조 및 수발(수분섭취, 치아위생, 세면 등)<br/> -식사 보조 : 식사수발<br/> – 말벗 등 : 동화책 읽어드리기, 신문읽어드리기 등<br/> – 노력봉사 : 생활공간, 거실, 프로그램실 등 청소 및 분리수거, 시설주변 환경정화 등",
